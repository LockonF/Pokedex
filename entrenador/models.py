...
class EntrenadorHasPokemon(models.Model):
    ...
    entrenador = models.ForeignKey(Entrenador, on_delete=models.CASCADE, related_name='entrenador_has_pokemon_entrenador')
    pokemon = models.ForeignKey(Pokemon, on_delete=models.CASCADE, related_name='entrenador_has_pokemon_pokemon')
